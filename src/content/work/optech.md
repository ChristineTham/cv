...
Tesla's design and architecture is the subject of [Distributed Computing and Risk Management](/cv/article/suntech-1990/), written with Tim Posney — one of the architects of TOPS, a sister product for interest rate over-the-counter options trading — and published in SunTech Journal in 1990. [The longer manuscript we submitted](/cv/article/optech-1990/) is here too.
