...
[ported Colossal Cave Adventure to TypeScript](/cv/article/adventure/), the game that
started all of this before Zork did, and rather more recently I put
[Rogue and its expert-system player in a browser](/cv/article/rogoweb/). Forty years on,
...
[breaking into their password file](/cv/article/crypt-usenix91/#postscript-thirty-five-years-on),
