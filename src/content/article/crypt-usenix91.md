...
[a program in eight languages](/cv/article/polyglot/) went out from in March 1991, that
[two HP 48 applications](/cv/article/hp48/) went out from that November, and that the
[InfoTaskForce](/cv/article/infotaskforce/) used for its bug reports. Everything I
