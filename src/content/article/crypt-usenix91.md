...
the address [two HP 48 applications](/cv/article/hp48/) went out from in November 1991,
and the address the [InfoTaskForce](/cv/article/infotaskforce/) published for its bug
reports. [A program in eight languages](/cv/article/polyglot/) had gone out earlier that
...
- [A scan of the proceedings](/cv/crypt-usenix91.pdf), which this reproduction was
  transcribed from.
