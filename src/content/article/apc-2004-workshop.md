...
**[Download the manuscript (DOC, 49 KB)](/cv/MyHTPC%20Workshop%20v3.doc)** · **[Download the Saturday draft (DOC, 58 KB)](/cv/MyHTPC%20Workshop%20v2.doc)** · **[Download the first week's draft (DOC, 50 KB)](/cv/MyHTPC%20Workshop.doc)**
...
- **The brief**, `BRIEF - Windows MyHTPC workshop.doc`, archived with [the roundup](/cv/article/apc-2004/): 1,400 words at AUD\$500, the batch's highest rate, with a prescribed structure this manuscript follows almost clause by clause — the standfirst integrating the byline, the workshop details block, the inside info bar of URLs, and "3 – 4 screenshots with 10-20 word captions in format slug: caption".
- **The invoice** that bills this piece in full for the September 2004 issue is described with [the roundup](/cv/article/apc-2004/), and deliberately not archived.
...
- [Digital TV Software](/cv/article/apc-2004/), [APC's edit of it](/cv/article/apc-2004-edit/), and [Remote controls for your HTPC](/cv/article/apc-2004-remotes/) — the rest of the batch. The roundup's myHTPC entry points at this piece with "see the APC tutorial on page XX".
