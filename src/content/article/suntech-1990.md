...
_This is a reproduction of an article from SunTech Journal, Volume 3, Number 1, Winter 1990, pages 46 to 52, published by Sun Microsystems, Inc. It was written with Tim Posney while I was at [Optech International](/cv/work/optech/). I have transcribed it from a scan of the issue: the wording is unchanged apart from two typesetting slips in the original, the figures are the printed ones, and the illustration is by Paul Wolf._

_This is what SunTech's readers saw. The longer version we submitted, with two sections the magazine dropped and the figures as we drew them, is [here](/cv/article/optech-1990/)._
