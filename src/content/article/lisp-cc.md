...
I enjoyed that subject enormously and did very well in it. It is why I proposed the honours topic I did the following year: [Rubato](/cv/article/rubato/), a language for writing music down and a system to perform it — which is to say, another compiler, pointed at something I actually cared about. That thesis won me the [University Medal](/cv/education/usyd/).
