...
[the March 2005 talk](/cv/article/ark-2005/). Two of this deck's slides travelled: slide 4's
Strategic Architecture Forum list is the one from [the BTELL talk](/cv/article/btell-2003/) the
...
- **The deck**, `Selling web services to senior management.ppt`, 1.1 MB, sixteen slides,
  ...
  and available for download at the head of this article.
- [Lessons Learnt from implementing and embedding an enterprise architecture team at National
  Wealth Management](/cv/article/btell-2003/), the July 2003 talk whose Strategic Architecture
...
- [The promise and pitfalls of implementing a Services Oriented Architecture](/cv/article/ark-2005/),
  ...
  Architecture](/cv/article/eac-2005/), its August 2005 successor.
