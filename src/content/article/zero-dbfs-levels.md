...
_This is the expanded version Audioholics ran. The shorter original, published on my own site a few months earlier, is also reproduced here: **[Experiments with 0dBFS+ levels on various players](/cv/article/zero-dbfs-experiments/)**._
