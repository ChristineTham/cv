...
_This is [the manuscript](/cv/article/apc-2004/) after APC's editor had been through it. Dan Warne saved this file at half past three on the afternoon of Sunday the 11th of July 2004, three hours after I finished mine, working in Word on a Mac where I had been on Windows. Its creation stamp is identical to the manuscript's, so it is my file carried forward rather than a rewrite from scratch, at revision 28 against my 25._
...
_**This is the edit and not the printed page.** It still carries "Price: To come" where a price should be and "page xx" where a cross-reference should be, so it was still in production when this copy was saved. It ran in the September 2004 issue — [the invoice that closed the batch names it](/cv/article/apc-2004/) — and the standfirst's "five of the best" is no longer a mystery: [the brief has since surfaced](/cv/article/apc-2004/), and it commissioned five reviews, the fifth being MythTV on Linux, which is in neither of my drafts. The standfirst was written from the brief, not from the copy._

**[Download APC's edit (DOC, 49 KB)](/cv/Digital%20TV%20Software%20v3.doc)** · **[Download my manuscript (DOC, 82 KB)](/cv/Digital%20TV%20Software%20v2.doc)**
...
- [My manuscript](/cv/article/apc-2004/), the version I sent, with the two earlier drafts and the account of how the piece was assembled.
...
- [Remote controls for your HTPC](/cv/article/apc-2004-remotes/), the third piece of the same batch, which no edit of survives.
