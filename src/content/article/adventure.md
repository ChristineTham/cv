...
I have always loved text adventures. I was one of the five in the [InfoTaskForce](/cv/article/infotaskforce/), the group at the University of Sydney that worked out how Infocom's virtual machine ran their games.
...
[Play it here](https://christham.net/adventure/), and the code is on [GitHub](https://github.com/ChristineTham/adventure). The method behind this one, [Hello Calc](/cv/article/hellocalc/) and [Rogoweb](/cv/article/rogoweb/) is in [chapter three of my book](https://christham.net/aidou/software.html).
